...
public enum City {
    ...
    GLYNCLWYN(-8, 10, -2, "Glynclwyn", MEDIUM, GLYTH_GAMEL, "Sheep"),
    GLYWEEN(0, 6, -6, "Glyween", SMALL, GLYTH_GAMEL, "Wine"),
    ...
    UDERNY(2, -6, 4, "Uderny", SMALL, UNDERGROUND, "Ale"),
    ULOGGH(0, 2, -2, "Uloggh", MAJOR, UNDERGROUND, "Ale"),
